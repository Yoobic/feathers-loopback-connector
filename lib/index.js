...
function coerceQueryEntry(value, key) {
  switch (key) {
    ...
    case '$sort':
      ...
      return { order: Object.keys(value).reduce(function (acc, key) {
    ...
    default:
      return { where: _defineProperty({}, key, value) };
  }
}
...
function coerceParamsToLoopbackFilter(_ref) {
  ...
  return _transform(query, function (acc, value, key) {
...
var Service = function () {
  ...
  _createClass(Service, [{
    ...
    value: function find(params) {
      ...
      return Promise.all([this.model.count(filter.where), this.model.find(filter)]).then(function (_ref2) {
    ...
    value: function patch(id, data, params) {
      ...
      if (id === null && !_isEmpty(filter.where)) {
        return this.model.updateAll(filter.where, data).then(function (result) {
          params.query = data;
          return _this.model.find(filter);
        });
      }
      return this.model.findById(id).then(function (result) {
        if (!result) {
        ...
        delete patchData.id;
        return _this.model.replaceById(id, patchData);
    ...
    value: function remove(id, params) {
      ...
      if (id === null && !_isEmpty(filter.where)) {
        return this.model.find(filter).then(function (results) {
          return _this2.model.destroyAll(filter.where).then(function () {
      ...
      return this.model.findById(id).then(function (result) {
        ...
        return _this2.model.destroyById(id).then(function () {
