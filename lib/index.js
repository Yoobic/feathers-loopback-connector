...
function coerceQueryEntry(value, key) {
  ...
  switch (key) {
    ...
    case '$in':
      return { path: ['where'].concat(path), key: 'inq', unset: key, value: value, composable: true };
    case '$nin':
      return { path: ['where'].concat(path), key: 'nin', unset: key, value: value, composable: true };
    case '$lt':
      return { path: ['where'].concat(path), key: 'lt', unset: key, value: value, composable: true };
    case '$lte':
      return { path: ['where'].concat(path), key: 'lte', unset: key, value: value, composable: true };
    case '$gt':
      return { path: ['where'].concat(path), key: 'gt', unset: key, value: value, composable: true };
    case '$gte':
      return { path: ['where'].concat(path), key: 'gte', unset: key, value: value, composable: true };
    case '$ne':
      return { path: ['where'].concat(path), key: 'neq', unset: key, value: value, composable: true };
    case '$not':
